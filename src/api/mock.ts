...
const CLASSES: PimClass[] = [
  {
    ...
    fields: [
      ...
      { id: 14, name: 'Image URL', type: 'image' },
...
const RECORDS: PimRecord[] = [
  {
    ...
    values: {
      ...
      '14': 'https://images.unsplash.com/photo-1591337676887-a217a6970a8a?w=400',
      '15': true,
      '16': '2023-09-22',
      '17': 'Electronics',
      '18': ['New', 'Featured'],
  ...
  },
  {
    ...
    values: {
      ...
      '14': 'https://images.unsplash.com/photo-1541807084-5c52b6b3adef?w=400',
      '15': true,
      '16': '2024-03-08',
      '17': 'Electronics',
      '18': ['New', 'Bestseller'],
...
const VIEWS: View[] = [
  {
    ...
    layout: [
      ...
      { fieldId: 17, x: 6, y: 4, w: 3, h: 2 },
      { fieldId: 18, x: 9, y: 4, w: 3, h: 2 },
    ],
